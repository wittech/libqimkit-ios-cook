Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/wittech/libqimcommon-ios.git", :tag=> s.version.to_s}

  s.ios.deployment_target   = '9.0'
  s.resource_bundles = {'QIMCommonResource' => ['QIMCommon/QIMKitCommonResource/*.{png,aac,caf,pem,wav,mp3}']}
